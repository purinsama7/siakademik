                    ...
                    <div class="col-lg-12">
                        <div class="panel">
							<div class="panel-heading">
                                ...
                                <h1 class="m-0 font-weight-bold text-primary">Data TU dan Pegawai</h1>
                                </div>
                                <div class="right">
                                    <button type="button" class="btn" data-toggle="modal" data-target="#exampleModal"> <span class="btn btn-sm btn-primary"> Tambah TU dan Pegawai</span></button>
                                </div>
                            </div>
								...
								<table id="example" class="table table-bordered">
									...
									<tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>{{ $tu->alamat }}</td>
                                            <td>
                                                <a href="/tu/{{$tu->id}}/edit" class="btn btn-cirle btn-warning btn-sm">
                                                    <i class="fa fa-edit" ></i>
                                                </a>
                                                <a href="/tu/{{$tu->id}}/delete" class="btn btn-sm btn-danger" onclick="return confirm('Yakin Mau Hapus Data') ">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah TU dan Pegawai</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="/tu/create" method="POST">
                    {{ csrf_field() }}
                ...
                <div class="form-row">
                    ...
                    <div sclass="form-group col-md-6">
