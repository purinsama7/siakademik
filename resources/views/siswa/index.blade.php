                    ...
                    <div class="col-lg-12">
                        <div class="panel">
							<div class="panel-heading">
                                ...
                                <h1 class="m-0 font-weight-bold text-primary">Data Siswa</h1>
                                </div>
                                <div class="right">
                                    <button type="button" class="btn" data-toggle="modal" data-target="#exampleModal"> <span class="btn btn-sm btn-primary"> Tambah Siswa</span></button>
                                </div>
                                <br/>
								...
								<table id="example" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>{{ $siswa->alamat }}</td>
                                            <td>
                                                <a href="/siswa/{{$siswa->id}}/edit" class="btn btn-cirle btn-warning btn-sm">
                                                    <i class="fa fa-edit" ></i>
                                                </a>
                                                <a href="/siswa/{{$siswa->id}}/delete" class="btn btn-sm btn-danger" onclick="return confirm('Yakin Mau Hapus Data') ">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body">
            ...
            <div class="form-group col-sm-6">
                ...
                <input name="nisn" type="text" class="form-control" id="exampleFormControlInput1" placeholder="NISN">
            </div>
            <div class="form-row">
                <div class="form-group col-md-6">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                <label for="exampleFormControinputCity">Tanggal Lahir</label>
        ...
        <div class="form-group col-sm-12">
            ...
            <input name="email" type="email" class="form-control" id="exampleFormControlInput1" placeholder="masukkan_email@gmail.com">
        </div>
        <div class="form-group">
